...
If the earlier tree size is larger than the server is aware of, an Unavailable error is returned with the latest SignedLogRoot attached in the google.rpc.Status.details. |
