...
func (m *GetLastInRangeByRevisionRequest) GetStartIndex() []byte {
	if m != nil {
		return m.StartIndex
	}
	return nil
...
func (m *GetLastInRangeByRevisionRequest) GetEndIndex() []byte {
	if m != nil {
		return m.EndIndex
	}
	return nil
...
var fileDescriptor_28d34dfba22a7ce2 = []byte{
	...
	,
}
